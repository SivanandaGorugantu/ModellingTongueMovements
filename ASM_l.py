...
d = {}
with open("FilesDictionary_l.txt") as f:
    for line in f:
       (key, val) = line.split()
       d[key] = val


train_fileNames = open("listmyfolder_l.txt", "r")
...
for iter in range(7, 10):
    ...
    dat = MeanShapeModel_l.main_mean(list(folds[iter])[0])
    ...
    '''    #try:
        with open(val_file, "r") as f:
            ...
            d_file = open("error_fold_l"+str(iter)+".txt", "a")
