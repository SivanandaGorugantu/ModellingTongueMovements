...
d = {}
with open("FilesDictionary_o.txt") as f:
    for line in f:
       (key, val) = line.split()
       d[key] = val


train_fileNames = open("listmyfolder_o.txt", "r")
...
for iter in range(7, 10):
    ...
    dat = MeanShapeModel_o.main_mean(list(folds[iter])[0])
...
'''        #try:
        with open(val_file, "r") as f:
            ...
            d_file = open("error_fold_o"+str(iter)+".txt", "a")
